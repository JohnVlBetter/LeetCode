...
public:
    bool isSameTree(TreeNode* p, TreeNode* q) {
        ...
        while (s1.size() && s2.size()) {
            ...
            if ((cur1->left != nullptr && cur2->right == nullptr) || (cur1->left == nullptr && cur2->right != nullptr)) {
                return false;
            }
            if ((cur1->right != nullptr && cur2->left == nullptr) || (cur1->right == nullptr && cur2->left != nullptr)) {
                return false;
            }
